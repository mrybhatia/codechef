...
LINK : https://www.codechef.com/AUG18B/problems/SPELLBOB
...
class main{
	public static void main(String[] argv){
		...
		for(int i=0;i<t;i++){
			String s1 = sc.next();
			String s2 = sc.next();
			if(((s1.charAt(0) == 'b' || s2.charAt(0) == 'b') && (s1.charAt(1) == 'o' || s2.charAt(1) == 'o') && (s1.charAt(2) == 'b' || s2.charAt(2) == 'b')) || ((s1.charAt(0) == 'o' || s2.charAt(0) == 'o') && (s1.charAt(1) == 'b' || s2.charAt(1) == 'b') && (s1.charAt(2) == 'b' || s2.charAt(2) == 'b')) || ((s1.charAt(0) == 'b' || s2.charAt(0) == 'b') && (s1.charAt(1) == 'b' || s2.charAt(1) == 'b') && (s1.charAt(2) == 'o' || s2.charAt(2) == 'o')) ){
